...
public class SearchProcessSimulatorService : ISearchProcessSimulatorService
{
    ...
    public void SimulateSearchProcess(int triesNumber)
    {
        ...
        for (int i = 0; i < triesNumber; i++)
        {
            ...
            InitHall(UsingType.UpdateBase, new SearchLoveTryEntity());
    ...
    public int FullRerunSearchProcessTryByName(string name, bool toPrint)
    {
        CleanupEnvironmentBeforeNextIteration();
    ...
    public List<SearchLoveTryEntity> GetCurrentLoveSearchesStatus()
    {
    ...
    private void InitHall(UsingType usingType, SearchLoveTryEntity searchLoveTry)
    {
